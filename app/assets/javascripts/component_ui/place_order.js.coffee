@PlaceOrderUI = flight.component ->
  ...
  @handleSuccess = (event, data) ->
    ...
    @resetForm(event)
    @order_book_url = "http://peatio1.coinrank.net/api/v2/depth.json?market=#{gon.market.id}"
    setTimeout =>
  ...
  @updateOrderBook = (url) ->
    $.getJSON "http://peatio1.coinrank.net/markets/#{gon.market.id}.json", (market_data) =>
